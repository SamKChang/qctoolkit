...
*  python interface  *
*********************/
static PyObject* knint(PyObject* self, PyObject* args){
...
static PyMethodDef KNInt[] ={
  {"knint", knint, METH_VARARGS,
      "analytic Gaussian derivative integral for density"},
  {NULL, NULL, 0, NULL}
};

/* module initialization */
PyMODINIT_FUNC initknint(void){
  (void) Py_InitModule("knint", KNInt);
